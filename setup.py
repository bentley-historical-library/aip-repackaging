...
setup(
    ...
    dependency_links=['git+https://github.com/bentley-historical-library/DAPPr.git#egg=DAPPr', 'git+https://github.com/bentley-historical-library/bhlaspaceapiclient.git#egg=bhlaspaceapiclient'],
